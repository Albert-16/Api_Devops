...
/// <summary>
/// Representa una línea de log generada durante el proceso de deploy.
...
public sealed class DeployLog
{
    ...
    /// <summary>Identificador del deploy al que pertenece este log.</summary>
    public Guid DeployRecordId { get; set; }
