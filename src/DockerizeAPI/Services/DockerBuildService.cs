...
/// <summary>
/// Wrapper sobre el CLI de Docker para construir y publicar imágenes.
...
/// </summary>
public sealed class DockerBuildService : IDockerBuildService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string arguments = BuildDockerBuildArguments(effectiveDockerfilePath, fullImageTag, effectiveContextPath, options);
    ...
    /// <summary>
    /// Construye la cadena de argumentos para docker build con todos los flags configurados.
    /// </summary>
    private static string BuildDockerBuildArguments(
        string dockerfilePath,
        string fullImageTag,
        string contextPath,
